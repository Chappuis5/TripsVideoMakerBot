...
def scriper(destination):
    absolute_path = os.path.dirname(__file__)
    relative_path = "data/CityBank.json"
    ...
    for i in range(num):
        if data[i]['city'] == destination:
            ...
            if rd == 0:
                ...
                str3 = f"Life would be better for everyone if {destination} wasn't known for its {attribut}. {attribut} there are so awful, that {attribut_stat} of the {people} claim that going to {destination} is gay."
            TTS(str3, "sound_2")
            ...
            if rd == 0:
                ...
                str7 = f"Uhuhuh. Well well. If you haven't reconsidered your choice yet, let me tell you something that will make you think twice."
            TTS(str7, "sound_6")
            ytbScraper(destination, keyword = "einstein", name = "video_6")
            ...
            if rd == 0:
                ...
                str9 = f"Okay, I scared you a little. But wait something else is scary."
            TTS(str9, "sound_8")
            ytbScraper(destination, keyword = "horror", name = "video_8")
